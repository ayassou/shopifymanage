...
class ShopifyClient:
    ...
    def get_articles(self, blog_id, limit=50):
        ...
        return self._make_request(
            'GET', f'blogs/{blog_id}/articles.json?limit={limit}')
    ...
    def delete_article(self, blog_id, article_id):
        ...
        """
        return self._make_request(
            'DELETE', f'blogs/{blog_id}/articles/{article_id}.json')
    ...
    def get_product_images(self,
        ...
        try:
            ...
            if product_id:
                ...
                if 'product' in product_data and 'images' in product_data[
                        'product']:
            ...
            if collection_id:
                products_response = self._make_request(
                    'GET',
                ...
                products_response = self._make_request(
                    'GET', f'products.json?limit={limit}')
                products = products_response.get('products', [])
    ...
    def get_product_image(self, product_id, image_id):
        ...
        """
        return self._make_request(
            'GET', f'products/{product_id}/images/{image_id}.json')
    ...
    def delete_product_image(self, product_id, image_id):
        ...
        """
        return self._make_request(
            'DELETE', f'products/{product_id}/images/{image_id}.json')
